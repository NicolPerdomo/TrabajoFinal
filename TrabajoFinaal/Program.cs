...
namespace TrabajoFinal
{
    class Program
    {
        ...
        private static bool listaEstudiantes;
        static pantalla pant = new pantalla();
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("5. Borrar estudiante");
                ...
                static void agregarEstudiante()
                {
                    ...
                    //aux=es el nuevo estudiante que se crea
                    Estudiantes AUX = new Estudiantes();
                    AUX.Codigo = Convert.ToInt32(cod);
                    AUX.Nombre = nom;
                    AUX.Correo = corr;
                    AUX.Nota1 = no1;
                    AUX.Nota2 = no2;
                ...
                static void listarEstudiantes()
                {
                    ...
                    {
                        Console.Write(itemEstudiante.Codigo);
                        Console.Write(itemEstudiante.Nombre);
                        Console.Write(itemEstudiante.Correo);
                        Console.Write(itemEstudiante.Nota1);
                        Console.Write(itemEstudiante.Nota2);
                        Console.Write(itemEstudiante.Nota3);
                        Console.Write(itemEstudiante.NotaFin);
                    }*/
                    int y = 6;
                    foreach (var itemEstudiante in ListaEstudiantes)
                ...
                if (Existe(Convert.ToInt32(cod)))
                {
                    ...
                    //Console.WriteLine ($"Nombre: {nom} Correo:{corr} Nota1:{no1} Nota2:{no2} Nota3:{no3})
                    Console.SetCursorPosition(38, 6);
                    ...
                    if (Existe(Convert.ToInt32(cod)))
                    {
                        ...
                        do
                        {
                            ...
                            Console.SetCursorPosition(40, 24); if (vali.Vacio(corr))
                                Console.SetCursorPosition(40, 24); if (vali.TipoCorreo(corr))
                                CorreoValido = true;
                        } while (!CorreoValido);
